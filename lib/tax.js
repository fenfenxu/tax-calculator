...
exports.calculator = function() {
    ...
    var calor = function(city, salary, options) {

        var ret = {};
    
        var standard = ret.standard = cities[city].tax;

        for(o in options){

            if(o in standard) {

                standard[o] = options[o];
            }
        }


        var insuranceBase = salary < standard.insuranceMax ? salary : standard.insuranceMax;
        ...
        var fundBase =  salary < standard.fundMax ? salary : standard.fundMax;
